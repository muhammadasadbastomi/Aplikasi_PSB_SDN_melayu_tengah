                                    ...
                                    <div class="card-content">
                                        <div class="card-body donut-chart-wrapper">
                                            ...
                                            <ul class="list-inline d-flex justify-content-around mb-0">
                                                <li> <span class="bullet bullet-xs bullet-warning mr-50"></span>Search
                                                </li>
                                                <li> <span class="bullet bullet-xs bullet-info mr-50"></span>Email
                                                </li>
                                                <li> <span class="bullet bullet-xs bullet-primary mr-50"></span>Social
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <li class="d-flex align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <div class="dropdown-toggle cursor-pointer" role="button"
                                                        ...
                                                        aria-haspopup="true" aria-expanded="false">All Task</div>
                                            ...
                                            <li class="widget-todo-item">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        <i
                                                            class='bx bx-grid-vertical mr-25 font-medium-4 cursor-move'></i>
                                                        <div class="checkbox checkbox-shadow">
                                                            <input type="checkbox" class="checkbox__input"
                                                                id="checkbox1">
                                                            <label for="checkbox1"></label>
                                                        </div>
                                                        <span class="widget-todo-title ml-50">Add SCSS and JS files
                                                            if required</span>
                                                    </div>
                                            ...
                                            <li class="widget-todo-item">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        ...
                                                        <span class="widget-todo-title ml-50">Check your changes,
                                                            before commiting</span>
                                                    </div>
                                                    <div class="widget-todo-item-action d-flex align-items-center">
                                            ...
                                            <li class="widget-todo-item completed">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        ...
                                                        <div class="checkbox checkbox-shadow">
                                                            <input type="checkbox" class="checkbox__input"
                                                                id="checkbox3" checked>
                                                            <label for="checkbox3"></label>
                                                        </div>
                                                        <span class="widget-todo-title ml-50">Dribble, Behance,
                                                            UpLabs & Pinterest Post</span>
                                                    </div>
                                                    <div class="widget-todo-item-action d-flex align-items-center">
                                                        <div class="badge badge-pill badge-light-primary mr-1">UI/UX
                                                        </div>
                                                        <div class="avatar bg-rgba-primary m-0 mr-50">
                                                            <div class="avatar-content">
                                            ...
                                            <li class="widget-todo-item">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        ...
                                                        <span class="widget-todo-title ml-50">Fresh Design Web &
                                                            Responsive Miracle</span>
                                                    </div>
                                                    <div class="widget-todo-item-action d-flex align-items-center">
                                                        <div class="badge badge-pill badge-light-info mr-1">Design
                                                        </div>
                                                        <div class="avatar m-0 mr-50">
                                            ...
                                            <li class="widget-todo-item">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        ...
                                                        <span class="widget-todo-title ml-50">Add Calendar page,
                                                            source, credit page in
                                                            documentation</span>
                                                    </div>
                                                    <div class="widget-todo-item-action d-flex align-items-center">
                                            ...
                                            <li class="widget-todo-item">
                                                <div
                                                    ...
                                                    <div class="widget-todo-title-area d-flex align-items-center">
                                                        ...
                                                        <span class="widget-todo-title ml-50">Add Angular
                                                            Starter-kit</span>
                                                    </div>
                                                    <div class="widget-todo-item-action d-flex align-items-center">
                                                        <div class="badge badge-pill badge-light-primary mr-1">UI/UX
                                        ...
                                        <li class="timeline-items timeline-icon-primary active">
                                            ...
                                            <div class="timeline-content">
                                                <img src="../../../app-assets/images/icon/pdf.png" alt="document"
                                                    height="23" width="19" class="mr-50">New Order.pdf
                                            </div>
                                        </li>
                                        <li class="timeline-items timeline-icon-primary active">
                                            ...
                                            <div class="timeline-content">
                                                <img src="../../../app-assets/images/icon/pdf.png" alt="document"
                                                    height="23" width="19" class="mr-50">Invoices.pdf
                                            </div>
                                        </li>
