                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->ayah->foto )}}" class="image-fluid" alt="responsive-image">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->ibu->foto )}}" class="image-fluid" alt="responsive-image">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->user->photos )}}" class="image-fluid" alt="responsive-image">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h2 class="text-center">Belum Ada Foto</h2>
                                            @elseif($data->wali_id == !null)
                                            <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->wali->foto )}}" class="image-fluid" alt="responsive-image">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <div class="text-center">
                                ...
                                @elseif($data->kk == !null)
                                <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->kk )}}" class="image-fluid" alt="responsive-image">
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <div class="text-center">
                                ...
                                <img style="height: 50%; width: 50%;" src="{{ url('images/biodata/'. $data->akte )}}" class="image-fluid" alt="responsive-image">
                                @endif
                            </div>
                        </div>
                    </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="agama_wali" name="agama_wali" placeholder="Masukkan Agama..." value="@if($data->agama == 1) Islam @elseif($data->agama == 2) Kristen Protestan @elseif($data->agama == 3) Katolik @elseif($data->agama == 4) Hindu @elseif($data->agama == 5) Buddha @elseif($data->agama == 5) Kong Hu Cu @endif">
</div>
<div class="form-group">
