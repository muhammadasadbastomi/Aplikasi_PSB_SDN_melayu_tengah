                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body card-dashboard">
                                    ...
                                    <a target="_blank" href="{{ route('cetakGuru') }}" class="btn btn-outline-default text-white float-right"> <i class="menu-livicon" data-icon="print-doc"></i> Cetak</a>
                                        ...
                                        <table class="table zero-configuration">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">@if($d->agama == 1) Islam @elseif($d->agama == 2) Kristen Protestan @elseif($d->agama == 3) Katolik @elseif($d->agama == 4) Hindu @elseif($d->agama == 5) Buddha @elseif($d->agama == 5) Kong Hu Cu @endif</td>
