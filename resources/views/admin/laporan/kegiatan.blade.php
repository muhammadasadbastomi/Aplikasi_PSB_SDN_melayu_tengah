...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Daftar Kegiatan</h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="col" class="text-center">
                        {{Carbon\Carbon::parse($d->tgl_mulai)->translatedFormat('d F Y')}} s/d
                        {{Carbon\Carbon::parse($d->tgl_akhir)->translatedFormat('d F Y')}}</td>
                    <td scope="col" class="text-center"> @if($d->keterangan == !null)
