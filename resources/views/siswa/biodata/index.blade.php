                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="jenis_kelamin"
                                                            name="jenis_kelamin">
                                                            <option value="1" @if($data->jenis_kelamin == 1 ) selected
                                                                @endif >Laki - Laki</option>
                                                            <option value="2" @if($data->jenis_kelamin == 2 ) selected
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="agama" name="agama">
                                                            <option value="1" @if($data->agama == 1 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 1))
                                                                selected @endif >Islam</option>
                                                            <option value="2" @if($data->agama == 2 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 2))
                                                                selected @endif >Kristen Protestan</option>
                                                            <option value="3" @if($data->agama == 3 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 3))
                                                                selected @endif >Katolik</option>
                                                            <option value="4" @if($data->agama == 4 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 4))
                                                                selected @endif >Hindu</option>
                                                            <option value="5" @if($data->agama == 5 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 5))
                                                                selected @endif >Buddha</option>
                                                            <option value="6" @if($data->agama == 6 ) selected @endif
                                                                @if(($data->agama == !null) && ($data->agama == 6))
                                                                selected @endif >Kong Hu Cu</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="tmp_lahir">Tempat Lahir</label>
                                                        <textarea class="form-control" id="tmp_lahir" name="tmp_lahir"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="anak_ke"
                                                            name="anak_ke" placeholder="Masukkan Anak Ke..."
                                                            value="{{ $data->anak_ke }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="jmlh_saudara">Jumlah Saudara</label>
                                                        <input type="text" class="form-control" id="jmlh_saudara"
                                                            name="jmlh_saudara" placeholder="Masukkan Jumlah Saudara..."
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_wali"
                                                            name="nama_wali" placeholder="Masukkan Nama Lengkap..."
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="jk_wali" name="jk_wali">
                                                            <option value="1" @if(($data->wali_id == !null) &&
                                                                ($data->wali->jenis_kelamin == 1)) selected @endif >Laki
                                                                - Laki</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="alamat_wali"
                                                            name="alamat_wali"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="agama_wali" name="agama_wali">
                                                            @if(isset($data->wali->agama))
                                                            <option value="1" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 1)) selected @endif >Islam
                                                            </option>
                                                            <option value="2" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 2)) selected @endif >Kristen
                                                                Protestan</option>
                                                            <option value="3" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 3)) selected @endif >Katolik
                                                            </option>
                                                            <option value="4" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 4)) selected @endif >Hindu
                                                            </option>
                                                            <option value="5" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 5)) selected @endif >Buddha
                                                            </option>
                                                            <option value="6" @if(($data->wali->agama) &&
                                                                ($data->wali->agama == 6)) selected @endif >Kong Hu Cu
                                                            </option>
                                                            @else
                                                            ...
                                                            <option value="2">Kristen
                                                                Protestan</option>
                                                            <option value="3">Katolik
                                                            </option>
                                                            <option value="4">Hindu
                                                            </option>
                                                            <option value="5">Buddha
                                                            </option>
                                                            <option value="6">Kong Hu Cu
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="tempat_lahir_wali"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="tgl_lahir_wali"
                                                            name="tgl_lahir_wali"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="pekerjaan_wali"
                                                            ...
                                                            value="@if($data->wali_id == !null){{ $data->wali->pekerjaan }}@endif">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="foto_wali">Foto</label>
                                                        <input type="file" name="foto_wali" id="foto_wali"
                                                            class="form-control"
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_ayah"
                                                            name="nama_ayah" placeholder="Masukkan Nama Lengkap..."
                                                            value="@if($data->ayah_id == !null){{ $data->ayah->nama }}@endif">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="alamat_ayah">Alamat</label>
                                                        <textarea class="form-control" id="alamat_ayah"
                                                            name="alamat_ayah"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="agama_ayah" name="agama_ayah">
                                                            <option value="1" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 1)) selected @endif >Islam
                                                            </option>
                                                            <option value="2" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 2)) selected @endif >Kristen
                                                                Protestan</option>
                                                            <option value="3" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 3)) selected @endif >Katolik
                                                            </option>
                                                            <option value="4" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 4)) selected @endif >Hindu
                                                            </option>
                                                            <option value="5" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 5)) selected @endif >Buddha
                                                            </option>
                                                            <option value="6" @if(($data->ayah_id == !null) &&
                                                                ($data->ayah->agama == 6)) selected @endif >Kong Hu Cu
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="tempat_lahir_ayah">Tempat Lahir</label>
                                                        <textarea class="form-control" id="tempat_lahir_ayah"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="pekerjaan_ayah"
                                                            name="pekerjaan_ayah" placeholder="Masukkan Pekerjaan..."
                                                            value="@if($data->ayah_id == !null){{ $data->ayah->pekerjaan }}@endif">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="foto_ayah">Foto</label>
                                                        <input type="file" name="foto_ayah" id="foto_ayah"
                                                            class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_ibu"
                                                            name="nama_ibu" placeholder="Masukkan Nama Lengkap..."
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="agama_ibu" name="agama_ibu">
                                                            <option value="1" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 1)) selected @endif >Islam
                                                            </option>
                                                            <option value="2" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 2)) selected @endif >Kristen
                                                                Protestan</option>
                                                            <option value="3" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 3)) selected @endif >Katolik
                                                            </option>
                                                            <option value="4" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 4)) selected @endif >Hindu
                                                            </option>
                                                            <option value="5" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 5)) selected @endif >Buddha
                                                            </option>
                                                            <option value="6" @if(($data->ibu_id == !null) &&
                                                                ($data->ibu->agama == 6)) selected @endif >Kong Hu Cu
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="tempat_lahir_ibu">Tempat Lahir</label>
                                                        <textarea class="form-control" id="tempat_lahir_ibu"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="pekerjaan_ibu"
                                                            name="pekerjaan_ibu" placeholder="Masukkan Pekerjaan..."
                                                            value="@if($data->ibu_id == !null){{ $data->ibu->pekerjaan }}@endif">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="foto_ibu">Foto</label>
                                                        <input type="file" name="foto_ibu" id="foto_ibu"
                                                            class="form-control"
